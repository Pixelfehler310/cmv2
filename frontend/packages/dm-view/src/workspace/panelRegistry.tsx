...
export type DmPanelId = "initiative" | "map" | "command-deck" | "action-deck";
...
const panelRegistry: Record<DmPanelId, DmPanelDefinition> = {
  ...
  "action-deck": {
    ...
    render: ({ bridge, campaignId, selectedCombatantId }) => <ActionDeck bridge={bridge} selectedCombatantId={selectedCombatantId} campaignId={campaignId} />,
  },
};
