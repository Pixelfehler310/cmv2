...
import { ThemeSwitcher } from "@rpg/ui";
      ...
      <div className="relative z-10 w-full max-w-md p-10 surface-card">
        ...
        <div className="gap-4 flex flex-col mb-10">
          <button
            ...
            className="w-full h-14 bg-white text-black border border-slate-200 font-bold rounded-full hover:bg-slate-50 transition-all flex items-center justify-center gap-3 shadow-sm hover:scale-[1.02] active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="w-full h-14 bg-[#5865F2] text-white font-bold rounded-full hover:bg-[#4752C4] transition-all flex items-center justify-center gap-3 shadow-lg shadow-[#5865F2]/20 hover:scale-[1.02] active:scale-[0.98]"
          >
