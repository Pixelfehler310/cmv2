...
from .systems.dnd5e.character.router import router as dnd5e_character_router
...
async def lifespan(app: FastAPI):
    ...
    if settings.LOAD_MOCK_DATA:
        # Note: Legacy data loader is disabled as part of the V05 Clean Break.
        # Once the unified V05 loader is ready, it will be re-enabled here.
        logger.info("LOAD_MOCK_DATA=true. Legacy fixture loader is DISABLED for V05.")
    else:
        logger.info(
...
app.include_router(dnd5e_character_router)
