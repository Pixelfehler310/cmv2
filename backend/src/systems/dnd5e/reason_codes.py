...
CHARACTER_SHEET_DENIED_REASON_CODES: set[str] = {
    "UNRESOLVED_CLASS_DEFINITION",
    "UNRESOLVED_SPECIES_DEFINITION",
    "UNRESOLVED_BACKGROUND_DEFINITION",
    "UNRESOLVED_ABILITY_DEFINITION",
    "MISSING_REQUIRED_FIELD",
    "CATALOG_REVISION_MISMATCH",
    "CAMPAIGN_OWNERSHIP_VIOLATION",
    "RECOVERY_DEADLINE_EXCEEDED",
    "SHEET_REVISION_REGRESSION",
}
