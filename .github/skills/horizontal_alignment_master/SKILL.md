...
2. **Master System Map (D2):** Build and maintain the `ISSUES/architecture/SYSTEM_MAP.d2` (standalone high-fidelity visualization).
...
- **Read the System Map First:** Always check the D2 map for module boundaries before changing Layer 1 contracts.
