# ISSUE [VERT][V05-10]: Asset Management Convergence & Media Linking
...
Game definitions are functionally incomplete without media. A `MonsterDefinition` needs a "Token Image," and a `LoreDefinition` (Region) needs a "Map." 
