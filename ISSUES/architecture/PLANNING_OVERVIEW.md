...
> **Instant Context**:
>
> - [What We Are Doing](WHAT_WE_ARE_DOING.md) — High-level strategy for this phase.
> - [Current Task Context](CURRENT_TASK.md) — Why this task is happening now.
>
> **Deep Technical Information**:
> Explore the **[System Information Repository](system_info/)** for detailed explanations of legacy systems and new architectural designs.
...
> [!TIP]
> **View Detailed Version**: For the canonical domain split, see the **[Horizontal Module Overview](01_contracts/overview/HORIZONTAL_MODULE_OVERVIEW.mmd)** and **[Horizontal Backend Namespace Overview](01_contracts/overview/HORIZONTAL_BACKEND_NAMESPACE_OVERVIEW.mmd)**.
...
- **No Orphan Logic**: Implementation logic (Layer 2) _must_ implement a contract from Layer 1.
...
- **Quality Integrity (PSQ)**: New production code MUST NOT import legacy `bronze` or `unchecked` modules. (Reference: [PSQ System](../archive/quality/ISSUE_[QUALITY]_[SYS-01]_production_status_quarantine.md)).
- **Horizontal Governance**: No code or models are finalized without a Deep Conceptualization diagram. (Reference: [Horizontal Planning Rule](../../.agents/rules/horizontal-planning.md)).
